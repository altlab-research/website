...
import { FileDown, Github, GitBranch, ArrowLeft, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-14 md:px-8 md:py-20">
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        ...
        {paper.researchArea && <Tag>{paper.researchArea}</Tag>}
      </div>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        {paper.paperPdf && (
          <a href={paper.paperPdf} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-lg bg-gradient-primary px-4 py-2 text-sm font-semibold text-white">
            <FileDown className="h-4 w-4" /> Download PDF
          </a>
        )}
        {paper.pdfUrl && !paper.paperPdf && (
        ...
        {paper.demoUrl && (
          <a href={paper.demoUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-lg border border-border px-4 py-2 text-sm font-medium hover:border-primary/50">
      ...
      {/* Architecture image above abstract */}
      {paper.architectureImageUrl && (
        <div className="mt-8 overflow-hidden rounded-xl border border-border">
          <Image
            src={paper.architectureImageUrl}

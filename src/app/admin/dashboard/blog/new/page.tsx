  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1 px-5 py-8 md:px-10 md:py-10">
        ...
        <h1 className="mt-4 font-display text-2xl font-bold">New Post</h1>
        ...
        <form onSubmit={handleSubmit} className="card-surface mt-6 max-w-2xl space-y-4 rounded-xl p-6">
          ...
          <Field label="Tags (comma separated)">
            <input value={tags} onChange={(e) => setTags(e.target.value)} className="input" placeholder="AltOS, Vision" />
          </Field>
